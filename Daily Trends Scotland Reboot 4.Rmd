...
daily_nation_vaccinations <- read_excel("data/S_SCO-UK-Testing-data.xlsx", sheet = "ExtraVaccinations", range = "W4:AB40")
j_d_nation_vaccinations = janitor::clean_names(daily_nation_vaccinations)

nation_vaccinations <- read_excel("data/S_SCO-UK-Testing-data.xlsx", sheet = "ExtraVaccinations", range = "AH4:AM40")
j_nation_vaccinations = janitor::clean_names(nation_vaccinations)

smoothed_nation_vaccinations <- read_excel("data/S_SCO-UK-Testing-data.xlsx", sheet = "ExtraVaccinations", range = "AN4:AS40")
...
v_title="Vaccination Rates (per 100 people)"
v_xlabel = "Date"
