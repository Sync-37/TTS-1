...
sc_d_cases_by_hb_labels <- sc_d_cases_by_hb[1,] 
...
p +  facet_wrap(~ variable, ncol=4,  scales = "free_y", as.table = TRUE) # plot matrix of individual charts.
