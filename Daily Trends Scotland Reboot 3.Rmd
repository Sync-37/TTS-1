...
ggsave(here(str_path, paste(today, v_image_file_name, "fb.jpg", sep = "", collapse=NULL)), dpi = 280, width = 8, height = 5)
ggsave(here(str_path, paste(today, v_image_file_name, "2240.jpg", sep = "", collapse=NULL)), dpi = 280, width = 8, height = 5)
ggsave(here(str_path, paste(today, v_image_file_name, "1680.jpg", sep = "", collapse=NULL)), dpi = 210, width = 8, height = 5)
ggsave(here(str_path, paste(today, v_image_file_name, "1120.jpg", sep = "", collapse=NULL)), dpi = 140, width = 8, height = 5)
ggsave(here(str_path, paste(today, v_image_file_name, "560.jpg", sep = "", collapse=NULL)), dpi = 70, width = 8, height = 5)
