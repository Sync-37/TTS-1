...
df_sc_test_ma_raw_zoom <- data.frame(j_sco_uk_testing_zoom) %>%
  select(date_notified, scot_daily_tests, z_scot_daily_tests_7_day_ma ) %>%
  gather(key = "variable", value = "value",-date_notified)
...
v_image_file_name = paste(today, "Daily Tests MA + Raw zoom.jpg", sep = "", collapse=NULL)
...
v_image_file_name = paste(today, "Percent daily positive MA + Raw zoom.jpg", sep = "", collapse=NULL)
