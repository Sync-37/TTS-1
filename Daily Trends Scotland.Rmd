...
ggplot(df_sc_uk_test, aes(x = date_notified, y = value)) + 
  geom_line(aes(color = variable)) + theme_light() + scale_color_manual(labels = c("Scotland", "Whole UK"),values = c("purple3", "steelblue3")  )+  
      labs(x = "Date", 
      y = "Tests", 
      title = "Average number of Covid tests per 100,000 population",
      caption = "Source: UK and Scottish gov statistics.",
       color = "") 
